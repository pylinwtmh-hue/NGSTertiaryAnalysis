...
| ADD_CALLERS_TAG stderr | 總 5,041,463：DV+HC 89.0%、DV only 3.0%、HC only 7.8%、NONE 8,771（0.2%；見下表：全部在男性 chrX/Y） |
...
| NONE | 8,771 | 8,656（全部在 chrX 2,607 / chrY 6,049＝男性性染色體上被 `+fixploidy` 截成 REF 的 het） |
